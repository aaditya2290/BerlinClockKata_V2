...
public class BerlinClockTest {
	...
	@Test
	public void testDigitalTimeToBerlinClockTimeConversionFirstArrayElementSizeShouldBe1(){
		assertEquals(1,clock.convertDigitalTimeToBerlinClockTime("00:00:00")[0].length());
	}
	...
	@Test
	public void testDigitalTimeToBerlinClockTimeConversionFourthArrayElementSizeShouldBe11(){
		assertEquals(11,clock.convertDigitalTimeToBerlinClockTime("00:00:00")[3].length());
	}
	
	@Test
	public void testDigitalTimeToBerlinClockTimeConversionFifthArrayElementSizeShouldBe4(){
		assertEquals(4,clock.convertDigitalTimeToBerlinClockTime("00:00:00")[4].length());
	}
	
	@Test
	public void testDigitalTimeToBerlinClockTimeConversionSecondsConversion(){
		assertEquals("Y",clock.convertDigitalTimeToBerlinClockTime("15:48:12")[0]);
	}
	
	@Test
	public void testDigitalTimeToBerlinClockTimeConversionFiveHoursRowConversion(){
		assertEquals("RRRO",clock.convertDigitalTimeToBerlinClockTime("15:48:12")[1]);
	}
	...
	@Test
	public void testDigitalTimeToBerlinClockTimeConversionSingleMinutesRowConversion(){
		assertEquals("YYYO",clock.convertDigitalTimeToBerlinClockTime("16:48:12")[4]);
	}
}
